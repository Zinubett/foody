...
<section id="main-content">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
<?php foreach ($menujour as $mejo)  :       ?>
          <tr data-expanded="true">
            
            <td><?php echo  $mejo['nom_repas'] ;  ?></td>
            <td><?php echo  $mejo['prix_unitaire'] ;  ?></td>
            <td><?php echo  $mejo['description'] ;  ?></td>
            <td><?php echo  $mejo['image'] ;  ?></td>
            
            
            
            <td>
            	<button type="button" class="btn btn-danger" onclick="suppmenujour(<?php echo  $mejo['id_menu'] ;  ?>)" >Supprimer</button>
            </td>
          </tr>
           <?php  endforeach ;    ?>
        </tbody>
