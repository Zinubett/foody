                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control" id="addlibile">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Prix:</label>
                                    <input type="int" class="form-control" id="addprix" >
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Description:</label>
                                    <input type="string" class="form-control" id="adddescription" >
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                        	<input type="button" class="btn btn-primary" name="valider" value="valider" onclick="insertmenu()">
