                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="addlibele">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Prix initial:</label>
                                    <input type="text" class="form-control" id="addprixinit" >
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Prix promotion:</label>
                                    <input type="text" class="form-control" id="addprixpromo">
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Date" class="form-control" id="adddatedebut" >
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Date fin:</label>
                                    <input type="Date" class="form-control" id="adddatefin">
                                </div>
                                 <div class="form-group">
                             ...
                             <input type="file"  id="addimage">
                                ...
                                <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="button" onclick="ajouterpromotion()">valider</button>
