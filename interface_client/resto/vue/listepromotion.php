 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
       <?php foreach ($promotion as $me)  :       ?>

          <tr data-expanded="true">
            <td><?php echo  $me['nom_promo'] ;  ?></td>
            <td><?php echo  $me['prix_unitiale'] ;  ?></td>
            <td><?php echo  $me['prix_promo'] ;  ?></td>
            <td><?php echo  $me['description_promo'] ;  ?></td>
            <td><?php echo  $me['date_debut'] ;  ?></td>
            <td><?php echo  $me['date_fin'] ;  ?></td>
            <td><?php echo  $me['image'] ;  ?></td>
            
            <td>
            	 <button type="button"  class="btn btn-warning" onclick="getpromotion(<?php echo  $me['id_promo'] ;  ?>)">
 Modifier
</button>
            	<button type="button" class="btn btn-danger" onclick="supppromotion(<?php echo  $me['id_promo'] ;  ?>)" >Supprimer</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form role="form">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Prix initial:</label>
                                    <input type="text" class="form-control" id="upprixinit" >
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Prix promotion:</label>
                                    <input type="text" class="form-control" id="upprixpromo">
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Date" class="form-control" id="updatedebut" >
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Date fin:</label>
                                    <input type="Date" class="form-control" id="updatefin">
                                </div>
                                 <div class="form-group">
                             ...
                             <input type="file"  id="upimage">
                                ...
                                <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <input type="hidden" id="id_promo_hidden">  
                                            <button class="btn btn-primary" type="button" onclick="modifierpromotion()">enregister modification</button>
