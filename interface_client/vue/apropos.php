        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 ">
              <h1 data-aos="fade-up">A propos YOUR FOOD</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-4 mb-lg-5 col-lg-3 text-left service-block" data-aos="fade-up" data-aos-delay="">
            ...
            <p>YOUR FOOD est une entreprise intermédiaire de la livraison de repas à domicile met en contact le restaurant et le client et en assure la livraison. Celles-ci sont spécialisées dans ce corps de métier. Le client commande son mets sur le site internet de l’intermédiaire ou sur l’application, c’est le phénomène de la « FoodTech ».</p>
          </div>
          <div class="col-md-6 mb-4 mb-lg-5 col-lg-3 text-left service-block" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>• YOUR FOOD est une façon facile de vous faire livrer vous repas préférés de restaurant qui vous choisissez.</p>
            <p>• La commande va arriver au lieu et le temps qui vous avez déterminez.</p>
          </div>
          ...
          <div class="col-md-6 mb-4 mb-lg-5 col-lg-3 text-left service-block" data-aos="fade-up" data-aos-delay="300">
            ...
            <p>• Notre application permettre au client de voire son adresse, l’heur de livraison et le prix de la commande, taxe et frais de livraison, lorsqu’il prêt à passer à la confirmation.</p>
          </div>

          <div class="col-md-6 mb-4 mb-lg-5 col-lg-3 text-left service-block" data-aos="fade-up" data-aos-delay="">
            <span class="wrap-icon"><span class="flaticon-cook d-block mb-4"></span></span>
            
            <p>• YOUR FOOD offrir aux restaurants partenaires un service de livraison fiable et clé en main, tout en leur fournissant une deuxième source de revenus.</p>
          </div>
        ...
        <div class="col-lg-6 pl-2 pl-lg-5">
            ...
            <div class="col-md-8 mx-auto contact-form-contact-info">
              <h4 class="mb-5">Les détails de notre contact</h4>
                <p class="d-flex">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-md-center text-left">
            <p>
          YOSRA BEN ARFA & ZAINAB ABDELKADER 2020
            </p>
          </div>
        </div>
      </div>
                ...
                <form data-toggle="validator">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                    <input type="text" class="form-control" id="addfacebook" placeholder="Facebook" required>
                  </div>
...
<!--modal authnetifier-->
<div class="modal fade" id="authentifier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
              ...
              <div class="widget-shadow" data-example-id="basic-forms"> 
               ...
               <div class="form-body">
                <form data-toggle="validator">
                  ...
                  <div class="form-group">
                     <button type="button"  class="btn btn-primary" onclick="conecter()">Connecter</button>
                  </div>
                </form>
              </div>
              </div>
