 ...
 <div class="panel panel-default">
    ...
    <div>
       <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
<?php foreach ($contact as $me)  :     ?>
          <tr data-expanded="true">
            
            <td><?php echo  $me['nom'] ;  ?></td>
            <td><?php echo  $me['telephone'] ;  ?></td>
            <td><?php echo  $me['email'] ;  ?></td>
            <td><?php echo  $me['message'] ;  ?></td>
           
            
            
            <td>
                
                <button type="button" class="btn btn-danger" onclick="suppmessage(<?php echo  $me['id_contact'] ;  ?>)">Supprimer</button>
