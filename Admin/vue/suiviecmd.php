        ...
        <tbody>
          ...
          <tr data-expanded="true">
            <?php foreach ($commande as $me)  :       ?>
               <td><?php echo  $me['id_client'] ;  ?></td>
               <td><?php echo  $me['id_rest'] ;  ?></td>
             ...
             if ($me['etat_commande']==1) {
                  echo "Envoyer au coursier";
             } 

             else if ($me['etat_commande']==2) {
               echo "le coursier accepte la commande";
             } 

             else if ($me['etat_commande']==3) {
               echo "le coursier refuse la commande";
             }

             else if ($me['etat_commande']==4) {
               echo "la commande cloture";

             } else if ($me['etat_commande']==5) {
               echo "la commande est pret";
            ...
            $id=$me['id_cmd'] ;
             ...
             if ($me['etat_commande']==3) {
                echo '<button class="btn btn-primary" type="button" onclick="controlercmd('.$id.')">changer coursier</button>';
              } 
...
?>
       ...
       <button type="button"  class="btn btn-success" onclick="updatecmdsui()">valider</button>
