 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
<?php foreach ($coursier as $me)  :       ?>
          <tr data-expanded="true">
               <td><?php echo  $me['nom_coursier'] ;  ?></td>
            <td><?php echo  $me['prenom_coursier'] ;  ?></td>
            <td><?php echo  $me['cin'] ;  ?></td>
            <td><?php echo  $me['tele_coursier'] ;  ?></td>
            <td><?php echo  $me['login_coursier'] ;  ?></td>
            <td><?php echo  $me['mp_coursier'] ;  ?></td>
            
            
            <td>
                
                <button type="button" class="btn btn-danger" onclick="suppcoursier(<?php echo  $me['id_coursier'] ;  ?>)">Supprimer</button>
